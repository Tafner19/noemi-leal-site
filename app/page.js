          ...
          <div className="flex flex-col gap-6 justify-center items-center md:items-end">
            ...
            <div className="w-full max-w-sm bg-[#18181b] rounded-xl p-4 flex flex-col gap-4 border border-zinc-800 relative overflow-hidden group shadow-lg">
              <div className="flex items-center justify-between z-10">
                ...
                <a 
                  href="https://open.spotify.com/track/47gYAsO6P2T3wA9m2Vw6yA"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="border-t border-zinc-800 pt-6">
              ...
              <ul className="space-y-2 text-zinc-400 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-pink-500" /> <strong>Softwares de Produção:</strong> Ableton Live e Reaper.
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-pink-500" /> <strong>Especializações:</strong> Produção musical, mixagem e masterização, composição, sound design.
                </li>
              </ul>
            </div>
          </div>
